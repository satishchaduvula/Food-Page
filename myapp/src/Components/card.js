...
import imge from "./foodimages/dark.jpg";
...
export default function card() {
  ...
  return (
    <div className="container">
      <h1 className="header">Banner Elements</h1>
      ...
      <h1 className="header">Section Elements</h1>
      <div
        className="container"
            ...
            <Card>
              <Card.Body>
                ...
                <Card.Text className="card">
                  {CardArray.map((value) => {
                    return (
                      value.parent_sec_no === item.sec_no && (
                        <>
                          <p className="cardbody">
                            {value.id}
                            <p>{value.card_title}</p>
                            {value.button && (
                              <button className="bt-name">
                                {value.button_name}
                              </button>
                            )}
                          </p>
